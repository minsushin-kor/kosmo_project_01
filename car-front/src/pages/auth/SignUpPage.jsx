...
const SIGNUP_TYPES = {
    COMPANY: "COMPANY",
    PERSONAL_DEALER: "PERSONAL_DEALER",
    MEMBER: "MEMBER",
};

const SIGNUP_TYPE_LABEL = {
    COMPANY: "회사계정",
    PERSONAL_DEALER: "개인딜러",
    MEMBER: "일반회원",
};

const SIGNUP_TYPE_ROLE = {
    COMPANY: AUTH_ROLES.COMPANY,
    PERSONAL_DEALER: AUTH_ROLES.DEALER,
...
function SignUpPage() {
    ...
    const isDealer = signupType === SIGNUP_TYPES.PERSONAL_DEALER;
    ...
    const handleSubmit = (e) => {
        ...
        const newUser = {
            ...
            profileImageName: !isMember ? profileImages[0]?.file?.name || "" : "",
            profileImagePreviewUrl: !isMember
