package com.car.app.car.controller;
...
public class CarController {
    ...
    public ResponseEntity<ApiResponse<Page<CarDto.Response>>> getCars(
        ...
        Page<Car> carPage = carService.searchCars(make, model, transmission, state, status, minPrice, maxPrice, minYear,
                maxYear, pageable);
    ...
    @GetMapping("/my")
    @PreAuthorize("hasAnyRole('MEMBER', 'DEALER')")
    public ResponseEntity<ApiResponse<List<CarDto.Response>>> getMyCars() {
        try {
            Authentication authentication = SecurityContextHolder
                    .getContext()
                    .getAuthentication();

            List<CarDto.Response> myCars = carService.getMyCars(
